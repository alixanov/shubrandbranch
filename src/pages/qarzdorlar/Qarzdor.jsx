...
import { Table, Button, Input, message, Modal, Form, Space, Select, Popover } from "antd";
import {
  useGetDebtorsQuery,
        ...
        {selectedDebtor?.products?.map((product, index) => {
          ...
          return (
            ...
            >
              ...
              <Button
                danger
                onClick={() => handleReturn(selectedDebtor._id, productId, index)}
              >
                Qaytarish
              </Button>
            </div>
